...
export default async function handler(req, res) {
  ...
  const APPS_SCRIPT_URL = process.env.APPS_SCRIPT_URL || 'https://script.google.com/macros/s/AKfycbz5NFXdWzctvpxzYmJAqtz6bKzmvma0rHK3m_KrKSd0gbhNWJ2-u6ChF_fA8vVEwYPE/exec';
